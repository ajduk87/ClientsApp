...
export class EditClientComponent implements OnInit {
  ...
  constructor(
    ...
    public settingstService:SettingsService,
  ) { }
  ...
  onSubmit({value, valid}:{value:Client, valid:boolean}){
    if(!valid){
      this.flashMessagesService.show('Morate uneti sva polja da bi ste nastavili dalje!', {cssClass:'alert-danger', timeout: 4000});
